...
class UnitTests::TestIrcMessage < Test::Unit::TestCase
  ...
  def test_RPL_MOTDSTART
    message = %{:asimov.freenode.net 375 crookshanks :- asimov.freenode.net Smirch::IrcMessage of the Day - }
    result = Smirch::IrcMessage.parse(message)
    assert_instance_of Smirch::IrcMessage::Numeric, result
    ...
    assert_equal %{- asimov.freenode.net Smirch::IrcMessage of the Day - }, result.text
  end
  ...
  def test_NOTICE_from_server
    ...
    result = Smirch::IrcMessage.parse(message)
    assert_instance_of Smirch::IrcMessage::Notice, result
  ...
  def test_PRIVMSG_from_user
    ...
    result = Smirch::IrcMessage.parse(message)
    assert_instance_of Smirch::IrcMessage::Privmsg, result
  ...
  def test_MODE_for_user
    ...
    result = Smirch::IrcMessage.parse(message)
    assert_instance_of Smirch::IrcMessage::Mode, result
  ...
  def test_PART
    ...
    result = Smirch::IrcMessage.parse(message)
    assert_instance_of Smirch::IrcMessage::Part, result
  ...
  def test_QUIT
    ...
    result = Smirch::IrcMessage.parse(message)
    assert_instance_of Smirch::IrcMessage::Quit, result
